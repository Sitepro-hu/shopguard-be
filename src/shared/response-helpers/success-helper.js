...
const SUCCESS_CODES = {
  ...
  // Product Category Group sikeres műveletek
  PRODUCT_CATEGORY_GROUP: {
    CREATE_SUCCESS: "PRODUCT_CATEGORY_GROUP.CREATE_SUCCESS",
    UPDATE_SUCCESS: "PRODUCT_CATEGORY_GROUP.UPDATE_SUCCESS",
    DELETE_SUCCESS: "PRODUCT_CATEGORY_GROUP.DELETE_SUCCESS",
    QUERY_SUCCESS: "PRODUCT_CATEGORY_GROUP.QUERY_SUCCESS",
  },
  ...
  // ProductLink sikeres műveletek
  PRODUCT_LINK: {
    CREATE_SUCCESS: "PRODUCT_LINK.CREATE_SUCCESS",
    UPDATE_SUCCESS: "PRODUCT_LINK.UPDATE_SUCCESS",
    DELETE_SUCCESS: "PRODUCT_LINK.DELETE_SUCCESS",
    QUERY_SUCCESS: "PRODUCT_LINK.QUERY_SUCCESS",
  },
  ...
  // InternationalContact sikeres műveletek
  INTERNATIONAL_CONTACT: {
    CREATE_SUCCESS: "INTERNATIONAL_CONTACT.CREATE_SUCCESS",
    UPDATE_SUCCESS: "INTERNATIONAL_CONTACT.UPDATE_SUCCESS",
    DELETE_SUCCESS: "INTERNATIONAL_CONTACT.DELETE_SUCCESS",
    QUERY_SUCCESS: "INTERNATIONAL_CONTACT.QUERY_SUCCESS",
  },

  // Glossary sikeres műveletek
  GLOSSARY: {
    CREATE_SUCCESS: "GLOSSARY.CREATE_SUCCESS",
    UPDATE_SUCCESS: "GLOSSARY.UPDATE_SUCCESS",
    DELETE_SUCCESS: "GLOSSARY.DELETE_SUCCESS",
    QUERY_SUCCESS: "GLOSSARY.QUERY_SUCCESS",
  },

  // Legal doc sikeres műveletek
  LEGAL_DOC: {
    CREATE_SUCCESS: "LEGAL_DOC.CREATE_SUCCESS",
    UPDATE_SUCCESS: "LEGAL_DOC.UPDATE_SUCCESS",
    DELETE_SUCCESS: "LEGAL_DOC.DELETE_SUCCESS",
    QUERY_SUCCESS: "LEGAL_DOC.QUERY_SUCCESS",
  },

  // Social media page sikeres műveletek
  SOCIAL_MEDIA_PAGE: {
    CREATE_SUCCESS: "SOCIAL_MEDIA_PAGE.CREATE_SUCCESS",
    UPDATE_SUCCESS: "SOCIAL_MEDIA_PAGE.UPDATE_SUCCESS",
    DELETE_SUCCESS: "SOCIAL_MEDIA_PAGE.DELETE_SUCCESS",
    QUERY_SUCCESS: "SOCIAL_MEDIA_PAGE.QUERY_SUCCESS",
  },
